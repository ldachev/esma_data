...
FITRS_SYNONYMS: dict[str, list[str]] = {
    ...
    "lis_threshold": ["lis_threshold", "large_in_scale_threshold", "LISThrshld"],
    "avt_currency": ["adt_curr_code", "avt_currency", "adt_currency", "currency"],
    "adnte_on_mrmtl": ["mrmtl_adnte", "adnte_on_mrmtl", "adnte_mrmtl"],
        ...
        rows.append(
            {
                ...
                "lis_threshold": to_float(_value(record, FITRS_SYNONYMS, "lis_threshold")),
                "avt_currency": normalize_upper(_value(record, FITRS_SYNONYMS, "avt_currency")),
                "adnte_on_mrmtl": to_float(_value(record, FITRS_SYNONYMS, "adnte_on_mrmtl")),
